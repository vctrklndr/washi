<template>
  <section class="Section Section--contain">
    <div class="Page-container">
      ...
      <p class="u-md-size1of2 u-textSpacing">
      ...
      <ul class="u-md-size1of2 u-marginTxlg">
        ...
        <li class="List-item">Du kan tvätta mellan klockan
          ...
          <span class="u-textHighlight u-textLarge ">22.00</span> (efter kl. 22.30 kommer du inte in)
        </li>
        <li class="List-item u-textLarge ">
        ...
        <li class="List-item u-textLarge ">Det är absolut förbjudet att färga kläder i tvättmaskinerna.</li>
        <li class="List-item u-textLarge ">Mattor och annan grovtvätt får endast tvättas i
